...
plt.suptitle("Netflix Contents Distribution",fontweight='bold',family='serif',fontsize=20)
...
sns.jointplot(md , x='date_added' , y='runtime_in_mins' , color='yellow')
...
sns.jointplot(md , x='release_year' , y='year_added' , color='blue')
...
plt.subplot(1,2,1)
plt.hist(fcum['days_to_add'], bins=30, color='green', edgecolor='white')
